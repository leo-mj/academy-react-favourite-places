import PlaceEntryProps from "./place-entry-props";

const entry1: PlaceEntryProps = {
...
const placeEntries: PlaceEntryProps[] = [entry1, entry2, entry3, entry4];
